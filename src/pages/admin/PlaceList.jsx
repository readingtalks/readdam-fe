  ...
  return (
    <div className="p-6 max-w-7xl mx-auto overflow-x-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-[#006989] text-white rounded-lg hover:bg-[#005C78] transition-all duration-200">
              ...
              <tr key={place.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    <button className="px-3 py-1.5 text-sm text-[#006989] hover:bg-[#006989] hover:text-white rounded transition-all duration-200">
                      수정
                    </button>
                    <button className="px-3 py-1.5 text-sm text-red-600 hover:bg-red-600 hover:text-white rounded transition-all duration-200">
                      삭제
                    </button>
                  </div>
                </td>
